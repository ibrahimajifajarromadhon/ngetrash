                            ...
                            <div class="tab-pane fade active show" id="nav-sign-in" role="tabpanel" aria-labelledby="nav-sign-in-tab">
                              <form id="form1" class="form-group flex-wrap p-3">
                                ...
                                <div class="form-input col-lg-12 my-4 mt-0">
                                  ...
                                  <input type="text" id="exampleInputEmail1" name="email" placeholder="Email" class="form-control ps-3" value="<?php echo $user->name; ?>" disabled>
                                </div>
                                <div class="form-input col-lg-12 my-4 mt-0">
                                  <label for="exampleInputEmail2" class="form-label fs-6 text-uppercase fw-bold text-black">Alamat</label>
                                  <input type="text" id="exampleInputEmail2" name="email" placeholder="Email" class="form-control ps-3" value="<?php echo $user->alamat; ?>" disabled></input>
                                </div>
                                <div class="form-input col-lg-12 my-4 mt-0">
                                  <label for="exampleInputEmail3" class="form-label fs-6 text-uppercase fw-bold text-black">Total Saldo</label>
                                  <input type="text" id="exampleInputEmail3" name="email" placeholder="Email" class="form-control ps-3" value="<?php echo $user->totalSaldo; ?>" disabled></input>
                                </div>
                              </form>
                            </div>
                          </div>
