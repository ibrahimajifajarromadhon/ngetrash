                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                            <tr>
                                                                ...
                                                                <td style="color: <?php echo ($r->status == 'Sudah Bayar') ? 'green' : 'red'; ?>;"><b><?php echo $r->status; ?></b></td>
                                                                <td style="color: <?php echo ($r->jenisBayar == 'Tunai') ? 'green' : 'blue'; ?>;"><b><?php echo $r->jenisBayar; ?></b></td>
                                                                <td>
                                                                    <?php
